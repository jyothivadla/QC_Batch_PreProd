	...
	@Test(priority=3)
	  public static void financialInformation(String SSN,String AppURL) throws Exception
	  {
		  try{
			...
			String Funding_Method = TestData.getCellData(sheetName,"Funding_Method",row);
...
//===========================================================================================================
		  ...
		  if(Funding_Method.equalsIgnoreCase("ACH / Electronic Transfer")){
			  test.log(LogStatus.PASS, "Selected Funding_Method type as " + Funding_Method);
			  
				 Thread.sleep(2000); 
				 
		         driver.findElement(By.xpath("//*[@id='disbType']")).sendKeys(Funding_Method);
		         test.log(LogStatus.PASS, "Selected Funding_Method type as " + Funding_Method );
		  ...
		  else if(Funding_Method.equalsIgnoreCase("Cash At Store")){
