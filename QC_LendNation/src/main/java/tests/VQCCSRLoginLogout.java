...
public class VQCCSRLoginLogout extends LendNation
{
	public static void login(String SSN,String AppURL)
	{
		try{
			...
			//ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+prop.getProperty("Test_data_sheet_path")+FileName+".xls");  		 
