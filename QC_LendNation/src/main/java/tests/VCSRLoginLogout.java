...
public class VCSRLoginLogout extends QCStore{
	...
	public static void logout(String SSN,String AppURL) throws InterruptedException{

		
			driver.switchTo().defaultContent();
			driver.switchTo().frame("topFrame");
			//wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("//*[@id='icons']/li[7]/a"))); 
