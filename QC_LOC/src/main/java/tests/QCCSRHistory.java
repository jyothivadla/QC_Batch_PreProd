...
//Loan paid to date summary
					...
					/*	String loc_history_transaction_test= driver.findElement(locator(prop.getProperty("loc_history_transaction"))).getText();
						...
						String loan_balance_inf_Current_Principal_Balance=driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[22]/td/span[2]")).getText();
