...
public class Database extends QCStore{
	...
	public static void connection(String SSN,String Appurl) throws ClassNotFoundException, SQLException {
		...
		try {
			...
			{
				 String SSN_DB = resultSet .getString(1);
				 String first_name_db = resultSet .getString(2);
				 String last_name_db = resultSet .getString(3);
				 String drivers_lin_db = resultSet .getString(4);
