...
public class QCStore {
	...
	@Test(priority = 1, enabled = true, groups = "Jyothi1")

	public void QC_PDL_MidDay_Deposit() throws Exception {

		FileName = "QC_PDL_MidDay_Deposit.xls";
		test = reports.startTest("QC_PDL_MidDay_Deposit", "QC_PDL_MidDay_Deposit");
