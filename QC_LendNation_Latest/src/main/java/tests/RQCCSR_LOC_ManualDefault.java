...
public class RQCCSR_LOC_ManualDefault extends LendNation{
	

	private static final WebDriver driver1 = null;
	private static String loan_number;
	private static String encryption_store_no;
	private static String customer_number;
	private static String encryption_transaction_nbr;
	private static CharSequence Eankey;
