	...
	public static void CmgDeposit(String SSN,String AppURL) throws Exception
	{
			...
			{		
		       ...
		       Thread.sleep(1000);
				...
				Thread.sleep(2000);
				driver.findElement(locator(Vprop.getProperty("CmgDeposite"))).click();
				...
				driver.findElement(locator(Vprop.getProperty("cmgDeposite_pin"))).sendKeys(PIN);
				test.log(LogStatus.PASS, "Enter cmgDeposite_pin menu");
				driver.findElement(locator(Vprop.getProperty("cmgFinishDeposit"))).click();
				...
				if(driver.findElement(locator(Vprop.getProperty("cmgSuccess"))).isDisplayed())
				{
