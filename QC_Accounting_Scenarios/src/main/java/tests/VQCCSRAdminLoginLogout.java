...
public class VQCCSRAdminLoginLogout extends QCStore {
	...
	public static void login(String SSN, String AppURL)
	{
		try{
			...
			{		
				...
				//String admin_url = TestData.getCellData(sheetName,"admin_url",row);
				...
				{	
					...
					test.log(LogStatus.PASS, "Application Launched with URL"+Vprop.getProperty("ADMIN_URL"));
