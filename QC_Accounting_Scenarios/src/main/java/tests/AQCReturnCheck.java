...
public class AQCReturnCheck extends QCStore{
	...
	public static void qcRturn(String SSN,String AppURL) throws Exception
	{
				...
				{		
					...
					if(SSN.equals(RegSSN))
					{
						...
						String StoreID = Vprop.getProperty("store_id");
						...
						action.click();
							...
							String req_loan_number=driver.findElement(By.xpath("/html/body/table/tbody/tr/td/table[2]/tbody/tr["+j+"]/td[5]")).getText();
							...
							driver.findElement(By.xpath("/html/body/table/tbody/tr/td/table[2]/tbody/tr["+j+"]/td[11]/select")).sendKeys(ReasonForReturn);
