...
public class QCDCPayment extends QCStore
{

	private static String PaydayLoans;
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					test.log(LogStatus.PASS, "TenderAmount is :"+TenderAmount);	
						...
						test.log(LogStatus.PASS, "TenderAmount is :"+TenderAmount);
						Thread.sleep(3000);	
						Select dropdown = new Select(driver.findElement(By.name("cardType")));
						dropdown.selectByIndex(1);
						test.log(LogStatus.PASS, "Clicked on Option1");
						driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr[9]/td/table/tbody/tr/td[1]/table/tbody/tr[25]/td[2]/div/input[3]")).click();
						test.log(LogStatus.PASS, "Clicked on Card not available");
						Select dropdown1 = new Select(driver.findElement(By.name("crditNbrFirst")));
...
break;
					...
					test.log(LogStatus.INFO, "Payment process is initiated again due to Application sync issue");
		...
		if(i==3)
		{
			test.log(LogStatus.FAIL, "Payment setup is failed");
