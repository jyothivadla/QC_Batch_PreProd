	...
	public static void chargeback(String SSN, String AppURL) throws Exception {
				...
				for (int row = 2; row <= lastrow; row++) {
					...
					if (SSN.equals(RegSSN)) {
						...
						rcount=rcount-3;
						String TXtype=	driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr[3]/td[6]")).getText();
						...
						if(TXtype.equalsIgnoreCase("Payment"))
						{
							...
							//driver.findElement(By.xpath(".//input[contains(@onclick, 'Payment')]"));
							driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table[2]/tbody/tr[3]/td/table/tbody/tr[3]/td[1]/input")).click();
							test.log(LogStatus.PASS,"Selected  Payment radio Button " );
							Thread.sleep(4000);
