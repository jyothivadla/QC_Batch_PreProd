...
public class AQC_ACHPayment extends QCStore{
	...
	public static void ACHPayment(String SSN,String AppURL) throws InterruptedException
	{
			...
			{	
				...
				if(SSN.equals(RegSSN))
				{
					...
					test.log(LogStatus.PASS, " click on finish ACH payment button");
					try {
					...
					{
						test.log(LogStatus.FAIL, "ACH Payment  is notsuccessfull");
						test.log(LogStatus.PASS, "********************************************** ");
					}
