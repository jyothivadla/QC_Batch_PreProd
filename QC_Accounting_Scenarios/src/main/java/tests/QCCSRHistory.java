...
//						//String cust_inf_customer_name= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[2]/td/span[2]")).getText();
//						//String cust_inf_customer_name= driver.findElement(locator(prop.getProperty("cust_inf_customer_name"))).getText();
//						
//						
	...
	public static void history(String SSN,String AppURL) throws ParseException, InterruptedException
	{
			...
			{	
				...
				if(SSN.equals(RegSSN))
				{
			     ...
			     //  String courtesy_consent_status=TestData.getCellData(sheetName_new_loan,"ESign_Preference",row);
			       ...
			       //String check_status=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",12);
			       String product_name=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",9);
			       String product_type=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",10);
	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
						...
						String loan_account_inf_product_name= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[2]/td/span[2]")).getText();
						                                                                        
						String loan_account_inf_product_type= driver.findElement(locator(Vprop.getProperty("loan_account_inf_product_type"))).getText();
						String loan_account_inf_loan_nbr= driver.findElement(locator(Vprop.getProperty("loan_account_inf_loan_nbr"))).getText();
						String loan_account_inf_loan_amt= driver.findElement(locator(Vprop.getProperty("loan_account_inf_loan_amt"))).getText();
						//String loan_account_inf_finance_charge= driver.findElement(locator(Vprop.getProperty("loan_account_inf_finance_charge"))).getText();
						...
						String loan_account_inf_inst_amt= driver.findElement(locator(Vprop.getProperty("loan_account_inf_loan_date"))).getText();
						//String loan_account_inf_no_of_installments= driver.findElement(locator(Vprop.getProperty("loan_account_inf_max_term_date"))).getText();
						...
						String loan_account_inf_original_store= driver.findElement(locator(Vprop.getProperty("loan_account_inf_original_store"))).getText();
						...
						String cust_promotion_coupon_code= driver.findElement(locator(Vprop.getProperty("cust_promotion_coupon_code"))).getText();
						cust_promotion_coupon_code= driver.findElement(locator(Vprop.getProperty("cust_promotion_coupon_code"))).getText();
//Loan paid to date summary
						String loan_paid_summary_principal_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[22]/td/span/span")).getText();
						                                                                           
						String loan_paid_summary_fee_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[23]/td/span/span")).getText();
						                                                                    
						String loan_paid_summary_return_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[24]/td/span[2]")).getText();
						                                                                        
						String loan_paid_summary_late_paid_date= driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[25]/td/span[2]")).getText();
						...
						//cust documetn details
						//String cust_transaction_date= driver.findElement(locator(Vprop.getProperty("cust_transaction_date"))).getText();
						...
						/*List<WebElement>  rows = driver.findElements(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr")); 
							...
							String cust_transaction_date=driver.findElement(By.xpath("/html/body/table/tbody/tr/td/table/tbody/tr/td/form/table[3]/tbody/tr["+n+"]/td[5]")).getText();
						...
						//To read from application       
						       ach_history_ach_type= driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[2]")).getText();
						     
								ach_history_ach_transaction= driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[3]")).getText();
